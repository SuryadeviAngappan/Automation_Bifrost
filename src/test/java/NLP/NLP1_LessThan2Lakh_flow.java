...
import GenericUtilities.DataBaseUtility_prod;
...
public class NLP1_LessThan2Lakh_flow extends BaseClass{
	...
	@Test(priority=2)
	public void landing_Page_NLP1_MTO_LT_2() throws SQLException, Throwable 
	{
		landingPage lp = new landingPage (BaseClass.driver);
		...
		ListnerClass.reportLog("Gst Selected by Customer is = "+Gst);
	...
	public void form2() throws Throwable 	
	{
		...
		String loanAmount=lp.LoanAmount("50000");
		ListnerClass.reportLog(" LoanAmount Needed Is  = " +loanAmount);
		String Businessman=lp.BusinessMan();
		ListnerClass.reportLog(" Customer Is  = " +Businessman);
		//String fullname=lp.FullName(ObjectReaders.readers.get_FullName());
		//ListnerClass.reportLog(" Customer's FullName Is  = " +fullname);
		wUtil.scrollToParticularElement(lp.PropritershipIcon);
		...
		ListnerClass.reportLog(" Customer's DateOfIncorporation Is  = " +date);
		//String form=lp.Propritership();
		//ListnerClass.reportLog(" Customer's Form Of Business Is  = " +form);
		lp.Continue();
	}
	...
	public void form3() throws InterruptedException 
	{
		...
		String gen=lp.Gender();
		ListnerClass.reportLog(" Customer's Gender Is  = " +gen);
		String dob=lp.DOB("30091997");
		ListnerClass.reportLog(" Customer's DOB Is  = " +dob);
		String pin=lp.Pincode("400001");
		ListnerClass.reportLog(" Customer's PinCode Is  = " +pin);
		wUtil.scrollToParticularElement(lp.PanNoFld);
		String acc=lp.CurrentAcc();
		ListnerClass.reportLog(" Customer's Having Current ACC  = " +acc);
		String Pan=lp.PanNo("BTLPN0219B");
		ListnerClass.reportLog(" Customer's PanNo Is  = " +Pan);
		lp.Continue();
	...
	public void Document() throws Throwable 
	{
		...
		ListnerClass.reportLog(" Document's Added Successfuly !!");
	...
	public void form4() throws InterruptedException 
	{
		...
		ListnerClass.reportLog(" Customer's Business PinCode Is  = " +pin);
		String rent=lp.ResidenceRented();
		ListnerClass.reportLog(" Does Customer's Residence Is Rented  = " +rent);
		String Rent=lp.BusinessRented();
		ListnerClass.reportLog(" Does Customer's Business Is Rented  = " +Rent);
		lp.Continue();
	}
...
//		ListnerClass.reportLog(" Customer's Pan No Is = "+pan);
		...
		ListnerClass.reportLog(" NLP-1 < 2lakh MTO Presanction Journey Completed  , Thank You!!");
