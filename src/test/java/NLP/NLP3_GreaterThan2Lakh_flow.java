...
public class NLP3_GreaterThan2Lakh_flow extends BaseClass{
	...
	@Test(priority=1)
	public void landing_Page_NLP3_GT2() throws Throwable 
	{

		landing lp = new landing(BaseClass.driver);

		String name=lp.Name(ObjectReaders.readers.get_FullName());
		ListnerClass.reportLog(" Customer's Name Is = "+name);
		...
		ListnerClass.reportLog(" Account Type Is = "+acc);
