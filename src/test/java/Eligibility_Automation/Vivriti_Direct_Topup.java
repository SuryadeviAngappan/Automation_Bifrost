...
public class Vivriti_Direct_Topup {
	...
	/*
	 * To verify the final capping if policy is Vivriti , ALL risk grade , no experiment, ABB & BTO
	 */
	...
	public void TC_01(String final_grade)  throws SQLException 
	{
		...
		ListnerClass.reportLog("TC_01 :"+" To verify the final capping if policy is Vivriti , ALL risk grade , no experiment, ABB & BTO");
