...
public class Vakil_Search  extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getVakil_search();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Vakil_Search_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Vakil_Search Presanction Journey Completed  , Thank You!!");
