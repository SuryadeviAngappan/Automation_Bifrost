...
public class EasyPay extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getEasyPay();
		driver.get(URL);
	}


	@Test(priority=1)
	public void EasyPay_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" EasyPay Presanction Journey Completed  , Thank You!!");
