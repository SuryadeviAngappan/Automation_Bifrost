...
public class FinePedia extends BaseClass{
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getFinePedia();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void FinePedia_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" FinePedia Presanction Journey Completed  , Thank You!!");
