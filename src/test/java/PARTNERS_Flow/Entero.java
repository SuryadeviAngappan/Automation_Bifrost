...
public class Entero extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getEntero();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Entero_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Entero Presanction Journey Completed  , Thank You!!");
