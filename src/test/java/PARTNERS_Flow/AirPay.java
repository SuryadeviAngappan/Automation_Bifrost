...
public class AirPay extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getAirpay();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void AirPay_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" AirPay Presanction Journey Completed  , Thank You!!");
