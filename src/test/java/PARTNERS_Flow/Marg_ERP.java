...
public class Marg_ERP extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getMarg_ERP();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Marg_ERP_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Marg_ERP Presanction Journey Completed  , Thank You!!");
