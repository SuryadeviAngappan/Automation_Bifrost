...
import POM_NLP1_GreaterThan_2.BankStatement;
...
public class Paisa_Bazar extends BaseClass{
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getPaisaBazar();
		driver.get(URL);
	}
	...
	@Test(priority=1)
	public void PaisaBazar_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Paisa_Bazar Presanction Journey Completed  , Thank You!!");
