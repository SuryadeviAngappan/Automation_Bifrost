...
public class Fino_Payment_Bank extends BaseClass{
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getFino();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Fino_Payment_Bank_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Fineway Presanction Journey Completed  , Thank You!!");
