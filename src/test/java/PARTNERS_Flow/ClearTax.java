...
public class ClearTax extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getClearTax();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void ClearTax_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" ClearTax Presanction Journey Completed  , Thank You!!");
