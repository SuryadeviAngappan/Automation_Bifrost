...
public class Tally extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getTally();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Tally_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Tally Presanction Journey Completed  , Thank You!!");
