...
public class Truecaller extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getTruecaller();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Truecaller_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Truecaller Presanction Journey Completed  , Thank You!!");
