...
public class Finance_Buddha extends BaseClass{
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getFinanceBuddha();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Finance_Buddha_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Finance_Buddha Presanction Journey Completed  , Thank You!!");
