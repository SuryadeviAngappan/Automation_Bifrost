...
public class MSSwipe extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getMSSwipe();
		driver.get(URL);
	}
	...
	@Test(priority=1)
	public void MSSwipe_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" MSSwipe Presanction Journey Completed  , Thank You!!");
	}
