...
public class Retailio extends BaseClass{
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getRetailio();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Retailio_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Retailio Presanction Journey Completed  , Thank You!!");
