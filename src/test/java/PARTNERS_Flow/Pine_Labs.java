...
public class Pine_Labs extends BaseClass {
	...
	public void launchURL() throws Throwable 
	{
		...
		String URL=ObjectReaders.readers.getPinelabs();
		driver.get(URL);
	}

	
	@Test(priority=1)
	public void Pine_Labs_landingPage() 
	{
	...
	public void form5() throws InterruptedException
	{
		...
		ListnerClass.reportLog(" Pine_Labs Presanction Journey Completed  , Thank You!!");
